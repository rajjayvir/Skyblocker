...
public class TitleContainerConfigScreen extends Screen {
    ...
    private float hudX = getConfig.get().general.titleContainer.x;
    private float hudY = getConfig.get().general.titleContainer.y;
    ...
    private float getSelectionHeight() {
        ...
        return getConfig.get().general.titleContainer.direction == SkyblockerConfig.Direction.HORIZONTAL ?
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        ...
        var alignment = getConfig.get().general.titleContainer.alignment;
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_Q) {
            SkyblockerConfig.Alignment current = getConfig.get().general.titleContainer.alignment;
            getConfig.get().general.titleContainer.alignment = switch (current) {
        ...
        if (keyCode == GLFW.GLFW_KEY_R) {
            SkyblockerConfig.Direction current = getConfig.get().general.titleContainer.direction;
            getConfig.get().general.titleContainer.direction = switch (current) {
        ...
        if (keyCode == GLFW.GLFW_KEY_EQUAL) {
            getConfig.get().general.titleContainer.titleContainerScale += 10;
        }
    ...
    @Override
    public void close() {
        getConfig.get().general.titleContainer.x = (int) hudX;
        getConfig.get().general.titleContainer.y = (int) hudY;
