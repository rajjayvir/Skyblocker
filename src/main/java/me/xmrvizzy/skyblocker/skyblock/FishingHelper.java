...
public class FishingHelper {
    ...
    public static void onSound(PlaySoundS2CPacket packet) {
        ...
        if (getConfig.get().general.fishing.enableFishingHelper && startTime != 0 && System.currentTimeMillis() >= startTime + 2000 && ("entity.generic.splash".equals(path) || "entity.player.splash".equals(path))) {
